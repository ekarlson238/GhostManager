...
namespace MonoGameLibrary.Sprite
{
    ...
    public class Sprite : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        {
            vp = this.Game.GraphicsDevice.Viewport;
            if((this.Location.X) <= (0 - this.Origin.X) || 
                this.Location.X + this.SpriteTexture.Width >= (vp.Width - this.Origin.X) ||
                (this.Location.Y) <= (0 - this.Origin.Y) ||
        ...
        public virtual bool IsOffScreenX()
        {
            vp = this.Game.GraphicsDevice.Viewport;
            if ((this.Location.X) <= (0 - this.Origin.X) ||
                this.Location.X + this.SpriteTexture.Width >= (vp.Width - this.Origin.X))
        ...
        public virtual bool IsOffScreenY()
        {
            vp = this.Game.GraphicsDevice.Viewport;
            if ((this.Location.Y) <= (0 - this.Origin.Y) ||
                this.Location.Y + this.SpriteTexture.Height >= (vp.Height - this.Origin.Y))
            {
                return true;
            }
